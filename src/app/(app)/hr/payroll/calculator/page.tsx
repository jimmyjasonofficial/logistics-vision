      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Calculate driver pay based on base salary and distance-based
            overtime.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select a driver and pay period to calculate their gross pay.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              The gross pay calculation for the selected driver and period.
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-baseline">
                  ...
                  <span className="font-mono text-lg">
                    N${result.baseSalary.toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between items-baseline">
                  <span className="text-muted-foreground">
                    Overtime ({result.totalKm.toLocaleString()} km at N$
                    {OVERTIME_RATE_PER_KM}/km)
                  </span>
                  <span className="font-mono text-lg">
                    + N${result.overtimePay.toFixed(2)}
                  </span>
                </div>
                <Separator />
