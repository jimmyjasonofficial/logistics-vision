  ...
  useEffect(() => {
    async function initializeForm() {
      ...
      const defaultValues = {
        ...
        lineItems: [
          { item: '', description: '', quantity: 1, unitPrice: 0, discount: 0, account: '200 - Sales', taxRate: 'Tax on Sales (15%)' },
        ],
    ...
    <div className="flex-1 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
            <Button type="button" variant="outline" onClick={() => router.push('/accounting/invoices')} disabled={loading}>Cancel</Button>
