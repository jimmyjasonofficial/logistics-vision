...
export function EditTripForm({ trip, customers, drivers, vehicles }: EditTripFormProps) {
  ...
  const form = useForm<TripFormValues>({
    ...
    defaultValues: {
        ...
        estimatedDelivery: new Date(trip.estimatedDelivery).toISOString().slice(0, 16),
        notes: trip.notes || '',
    },
  });
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update the primary information for the trip.</CardDescription>
            </CardHeader>
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" placeholder="0.00" {...field} disabled={loading} readOnly />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          <div className="flex justify-end gap-2 mt-6">
            <Button type="button" variant="outline" onClick={() => router.push(`/trips/${trip.id}`)} disabled={loading}>
              Cancel
            </Button>
